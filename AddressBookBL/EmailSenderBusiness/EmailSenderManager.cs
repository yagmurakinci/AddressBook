...
namespace AddressBookBL.EmailSenderBusiness
{
    public class EmailSenderManager : IEmailSenderManager
    {
        ...
        //appsetting.json içindeki AddressBookEmailOptions bölümünün altındaki  SenderMail değerini al
        public string SenderMail => _configuration.GetSection("AddressBookEmailOptions:SenderMail").Value;

        public string Password => _configuration.GetSection("AddressBookEmailOptions:Password").Value;

        public string Smtp => _configuration.GetSection("AddressBookEmailOptions:Smtp").Value;
        public int SmtpPort => int.Parse(_configuration.GetSection("AddressBookEmailOptions:SmtpPort").Value);
